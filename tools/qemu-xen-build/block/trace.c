...
uint16_t _TRACE_BACKUP_DO_COW_COPY_RANGE_FAIL_DSTATE;
...
TraceEvent _TRACE_BACKUP_DO_COW_COPY_RANGE_FAIL_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "backup_do_cow_copy_range_fail",
    .sstate = TRACE_BACKUP_DO_COW_COPY_RANGE_FAIL_ENABLED,
    .dstate = &_TRACE_BACKUP_DO_COW_COPY_RANGE_FAIL_DSTATE 
};
...
TraceEvent *block_trace_events[] = {
    ...
    &_TRACE_BACKUP_DO_COW_COPY_RANGE_FAIL_EVENT,
