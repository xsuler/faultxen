...
libs_softmmu=-lpixman-1 -lutil -lpng16 -lz -ljpeg -lxenstore -lxenctrl -lxenguest -lxendevicemodel -lxenforeignmemory -lxengnttab -lxenevtchn -lxentoolcore  -lfdt
GIT=git
...
VERSION=4.1.0
PKGVERSION=
SRC_PATH=/root/tm/faultxen/tools/qemu-xen-dir
TARGET_DIRS=i386-softmmu
CONFIG_X11=y
X11_CFLAGS=
X11_LIBS=-lX11
CONFIG_SDL=m
SDL_CFLAGS=-D_REENTRANT -I/usr/include/SDL2 -Wno-undef -D_REENTRANT -I/usr/include/SDL2 
...
CONFIG_PARALLELS=y
CONFIG_SHEEPDOG=y
TOOLS=qemu-keymap$(EXESUF) ivshmem-client$(EXESUF) ivshmem-server$(EXESUF) qemu-nbd$(EXESUF) qemu-img$(EXESUF) qemu-io$(EXESUF) qemu-edid$(EXESUF)  scsi/qemu-pr-helper$(EXESUF)
ROMS=optionrom
MAKE=make
INSTALL=install
...
CFLAGS_NOPIE=
QEMU_CFLAGS=-I/usr/include/pixman-1 -I$(SRC_PATH)/dtc/libfdt -Werror  -pthread -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -fPIE -DPIE -m64 -mcx16 -D_GNU_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Wstrict-prototypes -Wredundant-decls -Wall -Wundef -Wwrite-strings -Wmissing-prototypes -fno-strict-aliasing -fno-common -fwrapv -std=gnu99  -DXC_WANT_COMPAT_EVTCHN_API=1 	-DXC_WANT_COMPAT_GNTTAB_API=1 	-DXC_WANT_COMPAT_MAP_FOREIGN_API=1 	-DXC_WANT_COMPAT_DEVICEMODEL_API=1 	-I/root/tm/faultxen/tools/../tools/include 	-I/root/tm/faultxen/tools/../tools/libs/toolcore/include 	-I/root/tm/faultxen/tools/../tools/libs/toollog/include 	-I/root/tm/faultxen/tools/../tools/libs/evtchn/include 	-I/root/tm/faultxen/tools/../tools/libs/gnttab/include 	-I/root/tm/faultxen/tools/../tools/libs/foreignmemory/include 	-I/root/tm/faultxen/tools/../tools/libs/devicemodel/include 	-I/root/tm/faultxen/tools/../tools/libxc/include 	-I/root/tm/faultxen/tools/../tools/xenstore/include 	-I/root/tm/faultxen/tools/../tools/xenstore/compat/include 	 -Wexpansion-to-defined -Wendif-labels -Wno-shift-negative-value -Wempty-body -Wnested-externs -Wformat-security -Wformat-y2k -Winit-self -Wignored-qualifiers -Wold-style-declaration -Wold-style-definition -Wtype-limits -fstack-protector-strong  -I/usr/include/libpng16 -I$(SRC_PATH)/capstone/include
QEMU_CXXFLAGS= -D__STDC_LIMIT_MACROS -Werror -pthread -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -fPIE -DPIE -m64 -mcx16 -D_GNU_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Wall -Wundef -Wwrite-strings -fno-strict-aliasing -fno-common -fwrapv -std=gnu++98 -DXC_WANT_COMPAT_EVTCHN_API=1 -DXC_WANT_COMPAT_GNTTAB_API=1 -DXC_WANT_COMPAT_MAP_FOREIGN_API=1 -DXC_WANT_COMPAT_DEVICEMODEL_API=1 -I/root/tm/faultxen/tools/../tools/include -I/root/tm/faultxen/tools/../tools/libs/toolcore/include -I/root/tm/faultxen/tools/../tools/libs/toollog/include -I/root/tm/faultxen/tools/../tools/libs/evtchn/include -I/root/tm/faultxen/tools/../tools/libs/gnttab/include -I/root/tm/faultxen/tools/../tools/libs/foreignmemory/include -I/root/tm/faultxen/tools/../tools/libs/devicemodel/include -I/root/tm/faultxen/tools/../tools/libxc/include -I/root/tm/faultxen/tools/../tools/xenstore/include -I/root/tm/faultxen/tools/../tools/xenstore/compat/include -Wexpansion-to-defined -Wendif-labels -Wno-shift-negative-value -Wempty-body -Wformat-security -Wformat-y2k -Winit-self -Wignored-qualifiers -Wtype-limits -fstack-protector-strong -I/usr/include/libpng16 -I$(SRC_PATH)/capstone/include
QEMU_INCLUDES=-iquote $(SRC_PATH)/tcg -iquote $(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/root/tm/faultxen/tools/qemu-xen-build/linux-headers -iquote . -iquote $(SRC_PATH) -iquote $(SRC_PATH)/accel/tcg -iquote $(SRC_PATH)/include
AUTOCONF_HOST := 
LDFLAGS=-Wl,--warn-common -Wl,-z,relro -Wl,-z,now -pie -m64 -g  -L/root/tm/faultxen/tools/../tools/libxc 	-L/root/tm/faultxen/tools/../tools/xenstore 	-L/root/tm/faultxen/tools/../tools/libs/toolcore 	-L/root/tm/faultxen/tools/../tools/libs/evtchn 	-L/root/tm/faultxen/tools/../tools/libs/gnttab 	-L/root/tm/faultxen/tools/../tools/libs/foreignmemory 	-L/root/tm/faultxen/tools/../tools/libs/devicemodel 	-Wl,-rpath-link=/root/tm/faultxen/tools/../tools/libs/toolcore 	-Wl,-rpath-link=/root/tm/faultxen/tools/../tools/libs/toollog 	-Wl,-rpath-link=/root/tm/faultxen/tools/../tools/libs/evtchn 	-Wl,-rpath-link=/root/tm/faultxen/tools/../tools/libs/gnttab 	-Wl,-rpath-link=/root/tm/faultxen/tools/../tools/libs/call 	-Wl,-rpath-link=/root/tm/faultxen/tools/../tools/libs/foreignmemory 	-Wl,-rpath-link=/root/tm/faultxen/tools/../tools/libs/devicemodel 	-Wl,-rpath,/usr/local/lib/xen/lib
LDFLAGS_NOPIE=
