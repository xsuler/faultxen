...
static inline void _nocheck__trace_qio_channel_socket_listen_sync(void * ioc, void * addr)
{
    if (trace_event_get_state(TRACE_QIO_CHANNEL_SOCKET_LISTEN_SYNC) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:qio_channel_socket_listen_sync " "Socket listen sync ioc=%p addr=%p" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , ioc, addr);
    }
...
static inline void _nocheck__trace_qio_channel_socket_listen_async(void * ioc, void * addr)
{
    if (trace_event_get_state(TRACE_QIO_CHANNEL_SOCKET_LISTEN_ASYNC) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:qio_channel_socket_listen_async " "Socket listen async ioc=%p addr=%p" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , ioc, addr);
    }
