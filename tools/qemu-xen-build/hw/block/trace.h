...
static inline void _nocheck__trace_pflash_io_read(uint64_t offset, int width, int fmt_width, uint32_t value, uint8_t cmd, uint8_t wcycle)
{
    if (trace_event_get_state(TRACE_PFLASH_IO_READ) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:pflash_io_read " "offset:0x%04"PRIx64" width:%d value:0x%0*x cmd:0x%02x wcycle:%u" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , offset, width, fmt_width, value, cmd, wcycle);
    }
}

static inline void trace_pflash_io_read(uint64_t offset, int width, int fmt_width, uint32_t value, uint8_t cmd, uint8_t wcycle)
{
    if (true) {
        _nocheck__trace_pflash_io_read(offset, width, fmt_width, value, cmd, wcycle);
    }
}
...
static inline void _nocheck__trace_pflash_io_write(uint64_t offset, int width, int fmt_width, uint32_t value, uint8_t wcycle)
{
    if (trace_event_get_state(TRACE_PFLASH_IO_WRITE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:pflash_io_write " "offset:0x%04"PRIx64" width:%d value:0x%0*x wcycle:%u" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , offset, width, fmt_width, value, wcycle);
    }
}

static inline void trace_pflash_io_write(uint64_t offset, int width, int fmt_width, uint32_t value, uint8_t wcycle)
{
    if (true) {
        _nocheck__trace_pflash_io_write(offset, width, fmt_width, value, wcycle);
    }
}
...
static inline void _nocheck__trace_pflash_data_read(uint64_t offset, int width, uint32_t value)
{
    if (trace_event_get_state(TRACE_PFLASH_DATA_READ) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:pflash_data_read " "data offset:0x%04"PRIx64" value:0x%0*x" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , offset, width, value);
    }
...
static inline void trace_pflash_data_read(uint64_t offset, int width, uint32_t value)
{
    if (true) {
        _nocheck__trace_pflash_data_read(offset, width, value);
    }
}
...
static inline void _nocheck__trace_pflash_data_write(uint64_t offset, int width, uint32_t value, uint64_t counter)
{
    if (trace_event_get_state(TRACE_PFLASH_DATA_WRITE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:pflash_data_write " "data offset:0x%04"PRIx64" value:0x%0*x counter:0x%016"PRIx64 "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , offset, width, value, counter);
    }
}

static inline void trace_pflash_data_write(uint64_t offset, int width, uint32_t value, uint64_t counter)
{
    if (true) {
        _nocheck__trace_pflash_data_write(offset, width, value, counter);
    }
}
