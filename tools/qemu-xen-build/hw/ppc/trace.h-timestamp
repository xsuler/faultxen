...
#define TRACE_SPAPR_IRQ_FREE_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_SPAPR_IRQ_FREE) || \
    false)

static inline void _nocheck__trace_spapr_irq_free(int src, int irq, int num)
{
    if (trace_event_get_state(TRACE_SPAPR_IRQ_FREE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:spapr_irq_free " "Source#%d, first irq %d, %d irqs" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , src, irq, num);
    }
...
#define TRACE_SPAPR_IRQ_FREE_WARN_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_SPAPR_IRQ_FREE_WARN) || \
    false)

static inline void _nocheck__trace_spapr_irq_free_warn(int src, int irq)
{
    if (trace_event_get_state(TRACE_SPAPR_IRQ_FREE_WARN) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:spapr_irq_free_warn " "Source#%d, irq %d is already free" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , src, irq);
    }
