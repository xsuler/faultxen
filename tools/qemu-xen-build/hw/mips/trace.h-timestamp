...
static inline void _nocheck__trace_gt64120_read(const char * regname, int width, uint64_t value)
{
    if (trace_event_get_state(TRACE_GT64120_READ) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:gt64120_read " "gt64120 read %s value:0x%0*" PRIx64 "\n",
                 qemu_get_thread_id(),
...
static inline void trace_gt64120_read(const char * regname, int width, uint64_t value)
{
    if (true) {
        _nocheck__trace_gt64120_read(regname, width, value);
    }
}
...
static inline void _nocheck__trace_gt64120_write(const char * regname, int width, uint64_t value)
{
    if (trace_event_get_state(TRACE_GT64120_WRITE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:gt64120_write " "gt64120 write %s value:0x%0*" PRIx64 "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , regname, width, value);
    }
...
static inline void trace_gt64120_write(const char * regname, int width, uint64_t value)
{
    if (true) {
        _nocheck__trace_gt64120_write(regname, width, value);
    }
}
